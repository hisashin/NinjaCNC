...
public class GCodeSampleLevistoneTCream extends GCode {
	...
	public GCodeSampleLevistoneTCream() {
		...
		add(new Square(2.735, -0.1, 3.935, 1.37, stroke));
		add(new Square(5.3, -0.1, 6.77, 1.37, stroke));
		...
		add(new Square(10.237, 7.186, 10.937, 8.186, stroke));
		add(new Square(8.735, 7.186, 9.436, 8.186, stroke));
		...
		add(new Square(2.735, 5.3, 3.935, 6.77, stroke));
		add(new Square(5.3, 5.3, 6.77, 6.77, stroke));
		add(new Square(-0.1, 5.3, 1.37, 6.77, stroke));
		finalize();
	}
